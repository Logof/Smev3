...
@XmlRootElement(name = "MessageTypeSelector", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3")
public class MessageTypeSelector {

    @XmlElement(name = "NamespaceURI", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3")
    @XmlSchemaType(name = "anyURI")
    protected String namespaceURI;
    @XmlElement(name = "RootElementLocalName", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String rootElementLocalName;
    @XmlElement(name = "Timestamp", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar timestamp;
    @XmlElement(name = "NodeID", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3")
