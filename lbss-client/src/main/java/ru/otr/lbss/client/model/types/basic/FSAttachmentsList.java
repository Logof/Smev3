 ...
 *       &lt;sequence>
 *         &lt;element name="FSAttachment" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3}FSAuthInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "FSAttachmentsList", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3")
public class FSAttachmentsList {

    @XmlElement(name = "FSAttachment", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3", required = true)
